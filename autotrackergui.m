...
% Last Modified by GUIDE v2.5 02-May-2016 13:23:55
...
elseif isfield(handles, 'experiment') == 0 
...
% --------------------------------------------------------------------
function ymaze_Callback(hObject, eventdata, handles)
% hObject    handle to ymaze (see GCBO)
...
% --------------------------------------------------------------------
function arenaCircling_Callback(hObject, eventdata, handles)
% hObject    handle to arenaCircling (see GCBO)
...
% --------------------------------------------------------------------
function ledYmaze_Callback(hObject, eventdata, handles)
% hObject    handle to ledYmaze (see GCBO)
